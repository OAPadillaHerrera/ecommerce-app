...
import {
  ...
  isEmpty, // Validates that the property is empty (used internally or for advanced use cases).

} from 'class-validator'; // Importing validation decorators from the `class-validator` library.

import { Column } from 'typeorm'; // Decorator to define database column properties.
